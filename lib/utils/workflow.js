...
exports.getWorkflowRuns = (workflowId, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield octokit.paginate(octokit.actions.listWorkflowRuns.endpoint.merge(Object.assign(Object.assign({}, context.repo), { 'workflow_id': workflowId, status: 'in_progress', branch: yield misc_1.getTargetBranch(octokit, context), event: context.eventName }))));
});
